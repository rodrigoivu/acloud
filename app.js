...
var statepilas_routes = require('./routes/statepilas');
var statepiscina_routes = require('./routes/statepiscina');
...
app.use('/api', statepilas_routes);
app.use('/api', statepiscina_routes);
